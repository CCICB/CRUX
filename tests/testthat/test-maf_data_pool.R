test_that("We can identify when 'unique_names' are not unique", {
  ...
  #We add the same dataset tot he data pool twice
  maf_data_pool_acc <- tcga_dataset_to_data_pool(tcga_study_abbreviation = "ACC", maf_data_pool = maf_data_pool)
  maf_data_pool_two_acc <- tcga_dataset_to_data_pool(tcga_study_abbreviation = "ACC", maf_data_pool = maf_data_pool_acc)
  
  
  #The above will still have unique names (since if the unique name you try to use is taken, new_maf_data_pool will append strings to the end untill it is unique)
  #Manually make names identical
  maf_data_pool_two_acc[[1]][["unique_name"]] <- "SAME_UNIQUE_NAME"
  maf_data_pool_two_acc[[2]][["unique_name"]] <- "SAME_UNIQUE_NAME"
...
test_that("We can succesfully load data from unique_name", {
  my_data_pool <- new_maf_data_pool()
  mock_data1 = new_maf_dataset_wrapper(maf_data_pool = my_data_pool, display_name = "Hi1", short_name = "short_name", unique_name = "unique_name1", start_status = "not_loaded", data_description = "Some mock data", is_dataset_downloadable = TRUE, function_to_load_data = function(filepath) {maftools::read.maf(system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), verbose = FALSE)},name_of_data_source = "maftools", local_path_to_data = system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), datatype_of_stored_object = ".maf")
  mock_data2 = new_maf_dataset_wrapper(maf_data_pool = my_data_pool, display_name = "Hi2", short_name = "short_name", unique_name = "unique_name2", start_status = "not_loaded", data_description = "Some mock data", is_dataset_downloadable = TRUE, function_to_load_data = function(filepath) {maftools::read.maf(system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), verbose = FALSE)},name_of_data_source = "maftools", local_path_to_data = system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), datatype_of_stored_object = ".maf")
  mock_data3 = new_maf_dataset_wrapper(maf_data_pool = my_data_pool, display_name = "Hi3", short_name = "short_name", unique_name = "unique_name3", start_status = "not_loaded", data_description = "Some mock data", is_dataset_downloadable = TRUE, function_to_load_data = function(filepath) {maftools::read.maf(system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), verbose = FALSE)},name_of_data_source = "maftools", local_path_to_data = system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), datatype_of_stored_object = ".maf")
  mock_data4 = new_maf_dataset_wrapper(maf_data_pool = my_data_pool, display_name = "Hi4", short_name = "short_name", unique_name = "unique_name4", start_status = "not_loaded", data_description = "Some mock data", is_dataset_downloadable = TRUE, function_to_load_data = function(filepath) {maftools::read.maf(system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), verbose = FALSE)},name_of_data_source = "maftools", local_path_to_data = system.file('extdata', 'tcga_laml.maf.gz', package = 'maftools'), datatype_of_stored_object = ".maf")
