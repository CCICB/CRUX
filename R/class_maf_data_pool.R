...
class_is_maf_data_pool <- function(object){
    utilitybelt::class_is(object = object, tested_class = "maf_data_pool")
}
...
maf_data_pool_get_unique_names <- function(maf_data_pool) {
  ...
  unique_names <- utilitybelt::list_of_lists_retrieve_second_level_property(
...
# 
# maf_data_pool_uniquenames_are_unique <- function(maf_data_pool){
#   assert_that_class_is_maf_data_pool(maf_data_pool)
#   
...
# maf_data_pool_get_duplicated_uniquenames <- function(maf_data_pool){
#   assert_that_class_is_maf_data_pool(maf_data_pool)
#   
#   uniquenames <- maf_data_pool_get_unique_names(maf_data_pool)
#   duplicated_uniquenames <- uniquenames[duplicated(uniquenames)]
#   return(duplicated_uniquenames)
# }
...
maf_data_pool_make_name_unique <- function(maf_data_pool, name, max_number_of_attempts=50){
  ...
  utilitybelt::assert_is_whole_number(max_number_of_attempts)
